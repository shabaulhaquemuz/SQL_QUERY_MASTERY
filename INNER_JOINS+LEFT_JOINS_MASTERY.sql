...
-- 5. Show all courses and their department along with enrolled student names (include courses without students).
-- 6. List faculty names and student names they teach (show NULL for faculty with no students).
-- 7. Display all courses with their credits and student enrollment dates (include courses with no enrollments).
